          ...
          <div className="flat-animate-tab">
            <div className="tab-content">
              ...
              >
                <div className="row">
                  {isMapLoading ? (
                    <div className="col-12 py-5 text-center">Đang tải dữ liệu...</div>
                  ) : mapData.length === 0 ? (
                    <div className="col-12 py-5 text-center">Không tìm thấy BĐS nào trong khu vực này.</div>
                  ) : mapData.map((elm, i) => (
                          ...
                          >
                            ...
                            <div className="top">
                              <ul className="d-flex gap-6">
                                <li className={`flag-tag ${elm.listing_type === 'rent' ? 'success' : 'primary'}`}>{elm.listing_type === 'rent' ? 'Cho thuê' : 'Bán'}</li>
                              </ul>
                            </div>
                          ...
                          <div className="content-top">
                            ...
                            <ul className="meta-list">
                              <li className="item">
                                ...
                                <span className="fw-6">{elm.bedrooms || 0}</span>
                              </li>
                              <li className="item">
                                <i className="icon icon-bath" />
                                <span className="text-variant-1">Baths:</span>
                                <span className="fw-6">{elm.bathrooms || 0}</span>
                              </li>
                              <li className="item">
                                <i className="icon icon-sqft" />
                                <span className="text-variant-1">Sqft:</span>
                                <span className="fw-6">{formatArea(elm.area)}</span>
                              </li>
                            </ul>
                          </div>
                          <div className="content-bottom">
                            <div className="d-flex gap-8 align-items-center">
                              <div className="avatar avt-40 round">
                                <Image
                                  alt="avt"
                                  src={"/images/avatar/user-image.png"}
                                  width={34}
                                  height={34}
                                />
                              </div>
