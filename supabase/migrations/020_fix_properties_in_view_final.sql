-- Migration 020: Drop ALL overloaded versions of properties_in_view và tạo lại 1 version duy nhất

-- Drop tất cả overloaded versions (bất kể signature)
DO $$
DECLARE r RECORD;
BEGIN
  FOR r IN (
...
-- Tạo lại 1 version duy nhất với đầy đủ tất cả filters
...
-- Kiểm tra chỉ còn đúng 1 version
